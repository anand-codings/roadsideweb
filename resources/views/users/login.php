...
<head>
  ...
  <?php if(isset($stripe_detail) && !empty($stripe_detail) && isset($user) && !empty($user)){ ?>  
        ...
        <script type="text/javascript">
              ...
              tap('conversion', '<?=$stripe_detail->stripe_id?>', 0, {customer_id: '<?=$user->stripe_id?>'});
...
<div class="login-box">
  <div class="login-logo">
    ...
    <a href="http://driveroadside.com"><b>Road</b>SIDE</a>
    <?php if(isset($success) && !empty($success)){ ?>
        <h1>You have Successfully Subscribed for the <?=$plan?> Membership</h1>
    <?php } ?>
  </div>
  <!-- /.login-logo -->
