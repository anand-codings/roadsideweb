                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group img_size">
                                    ...
                                    <div class="profile_images">
                                        <img style="width: 299px;height: 300px;background-repeat: no-repeat;background-size: cover; background-position: center;" id='img-upload' alt="<?php $detail->avatar? '': 'Image not Found'?>"  src="<?= asset('public/images/'.$detail->avatar ); ?>"/>
                                    </div>
                                </div>
                            </div>
